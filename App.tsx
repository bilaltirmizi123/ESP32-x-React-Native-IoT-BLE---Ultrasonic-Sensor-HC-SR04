...
const App = () => {
  ...
  const [distanceFromObj, setDistanceFromObj] = useState(1033);
  ...
  const handleUpdateValueForCharacteristic = (
    ...
    console.log(
      `[handleUpdateValueForCharacteristic] received data from '${data.peripheral}' with characteristic='${data.characteristic}' and value='${stringVal}'`,
    );
  };
      ...
      {!Array.from(peripherals.values()).find((item) => item.connected) &&
        ...
        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
          ...
          <AnimatedCircularProgress
            ...
            // rotation={240}
            lineCap="round">
            {fill => <Text style={styles.points}>{distanceFromObj} cm</Text>}

          </AnimatedCircularProgress>
          
          { distanceFromObj < 20 && <Text  style={[styles.titleDevices,{ color:"red" }]}> CRITICAL!!! OBJECT TOO CLOSE</Text>}
        </View>
          }  
